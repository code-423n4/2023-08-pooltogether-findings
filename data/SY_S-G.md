...
| [G-04] | Using calldata instead of memory for read-only arguments | |1| | 
| [G-05] |Use hardcode address instead address(this)  | |7| | 
| [G-06] |Caching global variables is more expensive than using the actual variable (use block.timestamp instead of caching it) | |1|  
| [G-07] |Use do while loops instead of for loops | |2| | 
| [G-08] |Avoid contract existence checks by using low level calls | |6| | 
| [G-09] | Functions Guaranteed to revert when called by normal users can be markd payable  | |5| | 
| [G-10] |Ternary operation is cheaper than if-else statement | |2| | 
| [G-11] | `>=` costs less gas than > | |11| | 
| [G-12] | Stack variable used as a cheaper cache for a state variable is only used once | |1| | 
| [G-13] |Using delete statement can save gas | |3| | 
| [G-14] |Use nested if and, avoid multiple check combinations `&&` | |2| | 
| [G-15] |Internal functions not called by the contract should be removed to save deployment gas | |1| | 
| [G-16] |Use assembly to write address storage values | |5| | 
| [G-17] |Structs can be packed into fewer storage slots by editing variables | |2| | 
...
## [G-1] Missing zero address check in constructor
...
## [G-4] Using calldata instead of memory for read-only arguments
...
## [G-6] Caching global variables is more expensive than using the actual variable (use block.timestamp instead of caching it)
...
## [G-7] Use do while loops instead of for loops
...
## [G-9] Functions Guaranteed to revert when called by normal users can be markd payable
...
```
https://github.com/GenerationSoftware/pt-v5-cgda-liquidator/blob/7f95bcacd4a566c2becb98d55c1886cadbaa8897/src/libraries/ContinuousGDA.sol#L14
## [G-13] Using delete statement can save gas
...
## [G-17] Structs can be packed into fewer storage slots by editing variables
